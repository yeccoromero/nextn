...
export default function TracksView({ scrollRef, panelWidth, originMs, msPerPx }: { scrollRef: RefObject<HTMLDivElement>, panelWidth: number, originMs: number, msPerPx: number }) {
